class Solution:
    def minimumSteps(self, s: str) -> int:
        ...
        element is "1", aka the black ball, I would simply find out the number of steps it takes to move it all the way right by subtracting the element's index by the 
